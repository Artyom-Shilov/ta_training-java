package com.epam.training.artsiom_shylau.classes.maintask.storage.impl;
...
import com.epam.training.artsiom_shylau.classes.maintask.storage.BookStorage;
...
public class ArrayBookStorage implements BookStorage {
    ...
    public Book[] findBooksByAuthor(String author) throws BookStorageException {
        if (author == null || author.equals("") || author.equals(" ")) {
            throw new BookStorageException("wrong format for author's name");
        }
        return Arrays.stream(books)
                .limit(booksAmount)
