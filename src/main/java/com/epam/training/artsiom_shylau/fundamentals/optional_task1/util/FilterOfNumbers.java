package com.epam.training.artsiom_shylau.fundamentals.optional_task1.util;

import com.epam.training.artsiom_shylau.fundamentals.optional_task1.exception.OptionalTask1Exception;
import com.epam.training.artsiom_shylau.fundamentals.optional_task1.validation.ValidatorFilterOfNumbers;

import java.util.ArrayList;
import java.util.List;

public class FilterOfNumbers {
    ...
    public int[] findShortestNumberAndItsLength(int[] array) throws OptionalTask1Exception {
        ValidatorFilterOfNumbers.validateArray(array);
        if (array.length == 1) {
    ...
    public int[] findLongestNumberAndItsLength(int[] array) throws OptionalTask1Exception {
        ValidatorFilterOfNumbers.validateArray(array);
        if (array.length == 1) {
            numberAndItsLength[0] = array[0];
            numberAndItsLength[1] = findAmountOfDigitsInNumber(array[0]);
    ...
    public void sortNumbersInLengthIncreasingOrder(int[] array) throws OptionalTask1Exception {
        ValidatorFilterOfNumbers.validateArray(array);
        for (int i = 1; i < array.length; i++) {
    ...
    public double findAverageLengthOfElements(int[] array) throws OptionalTask1Exception {
        ValidatorFilterOfNumbers.validateArray(array);
        int sumLength = 0;
    ...
    public int[] findNumbersWithLengthLessThanAverage(int[] array) throws OptionalTask1Exception {
    ...
    public int findFirstNumberWithMinimumAmountOfUniqueDigits(int[] array) throws OptionalTask1Exception {
        ValidatorFilterOfNumbers.validateArray(array);
        if (array.length == 1) {
            return array[0];
        }
